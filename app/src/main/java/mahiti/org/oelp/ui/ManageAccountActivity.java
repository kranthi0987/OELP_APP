...
import mahiti.org.oelp.ui.adapter.AccountAdapter;
...
public class ManageAccountActivity extends XmppActivity implements XmppConnectionService.OnAccountUpdate, KeyChainAliasCallback, XmppConnectionService.OnAccountCreated, AccountAdapter.OnTglAccountState {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        if (this.selectedAccount.isEnabled()) {
            menu.findItem(R.id.mgmt_account_announce_pgp).setVisible(mahiti.org.oelp.Config.supportOpenPgp());
        } else {
    ...
    void onBackendConnected() {
        ...
        if (mahiti.org.oelp.Config.X509_VERIFICATION && this.accountList.size() == 0) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (mahiti.org.oelp.Config.X509_VERIFICATION) {
