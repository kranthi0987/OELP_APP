...
import static mahiti.org.oelp.ui.SettingsActivity.BROADCAST_LAST_ACTIVITY;
...
import static mahiti.org.oelp.ui.SettingsActivity.FORBID_SCREENSHOTS;
...
public class SetSettingsActivity extends XmppActivity implements XmppConnectionService.OnAccountUpdate {
    ...
    private void showInfo(int setting) {
        Log.d(mahiti.org.oelp.Config.LOGTAG, "STRING " + setting);
        String title;
        String message;
        switch (setting) {
