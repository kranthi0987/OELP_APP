...
package mahiti.org.oelp.ui.service;
...
public final class CameraManager {
    ...
    public Camera open(final TextureView textureView, final int displayOrientation, final boolean continuousAutoFocus)
        ...
        try {
            ...
            if (savedParameters != null) {
                ...
                try {
                    ...
                    Log.d(mahiti.org.oelp.Config.LOGTAG,"problem setting camera parameters", x2);
                }
            }
        }
        ...
        try {
            ...
            Log.w(mahiti.org.oelp.Config.LOGTAG,"something went wrong while starting camera preview", x);
            camera.release();
            throw x;
        }
    }
    ...
    public void close() {
        if (camera != null) {
            try {
                ...
                Log.w(mahiti.org.oelp.Config.LOGTAG,"something went wrong while stopping camera preview", x);
            }
