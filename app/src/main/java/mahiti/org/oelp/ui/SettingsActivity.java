...
import mahiti.org.oelp.services.ExportBackupService;
import mahiti.org.oelp.services.MemorizingTrustManager;
import mahiti.org.oelp.ui.util.StyledAttributes;
...
public class SettingsActivity extends XmppActivity implements
    ...
    public void onStart() {
        ...
        if (mahiti.org.oelp.Config.FORCE_ORBOT) {
        ...
        if (mahiti.org.oelp.Config.ONLY_INTERNAL_STORAGE) {
        ...
        if (useBundledEmojis != null) {
            Log.d(mahiti.org.oelp.Config.LOGTAG, "Bundled Emoji checkbox checked: " + isBundledEmojiChecked);
        ...
        if (enableMultiAccountsPreference != null) {
            Log.d(mahiti.org.oelp.Config.LOGTAG, "Multi account checkbox checked: " + isMultiAccountChecked);
            if (isMultiAccountChecked) {
                enableMultiAccountsPreference.setEnabled(false);
                int accounts = getNumberOfAccounts();
                Log.d(mahiti.org.oelp.Config.LOGTAG, "Disable multi account: Number of accounts " + accounts);
                if (accounts > 1) {
                    Log.d(mahiti.org.oelp.Config.LOGTAG, "Disabling multi account not possible because you have more than one account");
                    enableMultiAccountsPreference.setEnabled(false);
                } else {
                    Log.d(mahiti.org.oelp.Config.LOGTAG, "Disabling multi account possible because you have only one account");
    ...
    private void changeOmemoSettingSummary() {
        ...
        if (omemoPreference != null) {
            ...
            Log.d(mahiti.org.oelp.Config.LOGTAG, "unable to find preference named " + OMEMO_SETTING);
        }
    }
