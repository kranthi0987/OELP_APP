...
import mahiti.org.oelp.databinding.ActivityStartConversationBinding;
...
import mahiti.org.oelp.ui.adapter.ListItemAdapter;
        ...
        if (context instanceof XmppActivity) {
            ...
            try {
                if (mahiti.org.oelp.Config.DOMAIN_LOCK != null) {
                    jid = Jid.of((String) spinner.getSelectedItem(), mahiti.org.oelp.Config.DOMAIN_LOCK, null);
                } else {
