...
public abstract class LocationActivity extends XmppActivity implements LocationListener {
    ...
    protected void requestLocationUpdates() {
        ...
        if (locationManager.getAllProviders().contains(LocationManager.NETWORK_PROVIDER)
            ...
            locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, mahiti.org.oelp.Config.LOCATION_FIX_TIME_DELTA, mahiti.org.oelp.Config.LOCATION_FIX_SPACE_DELTA, this);
        }
        if (locationManager.getAllProviders().contains(LocationManager.GPS_PROVIDER)
                && locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
            locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, mahiti.org.oelp.Config.LOCATION_FIX_TIME_DELTA, Config.LOCATION_FIX_SPACE_DELTA, this);
        }
