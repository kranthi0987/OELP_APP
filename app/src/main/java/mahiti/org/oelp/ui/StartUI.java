...
public class StartUI extends AppCompatActivity
    ...
    private void requestNeededPermissions() {
        ...
        if (EasyPermissions.hasPermissions(this, perms)) {
            ...
            Log.d(mahiti.org.oelp.Config.LOGTAG, "All permissions granted, starting " + getString(R.string.app_name) + "(" + FirstStartTime + ")");
            ...
            Log.d(mahiti.org.oelp.Config.LOGTAG, "Requesting required permissions");
    ...
    public void onPermissionsGranted(int requestCode, List<String> list) {
        Log.d(mahiti.org.oelp.Config.LOGTAG, "Permissions granted:" + requestCode);
    }
