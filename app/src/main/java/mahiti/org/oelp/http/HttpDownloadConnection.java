    ...
    private class FileSizeChecker implements Runnable {
        ...
        private void retrieveUrl() {
            ...
            mXmppConnectionService.sendIqPacket(message.getConversation().getAccount(), request, (a, packet) -> {
                ...
                Log.d(mahiti.org.oelp.Config.LOGTAG, "unable to retrieve actual download url");
                retrieveFailed(null);
            });
        }
        ...
        private void check() {
            ...
            try {
                ...
                Log.d(mahiti.org.oelp.Config.LOGTAG, "io exception in http file size checker: " + e.getMessage());
                retrieveFailed(e);
                return;
            }
        ...
        private long retrieveFileSize() throws IOException {
            try {
                Log.d(mahiti.org.oelp.Config.LOGTAG, "retrieve file size. interactive:" + String.valueOf(interactive));
                changeStatus(STATUS_CHECKING);
                ...
                Log.d(mahiti.org.oelp.Config.LOGTAG, "url: " + connection.getURL().toString());
                ...
                connection.setReadTimeout(mahiti.org.oelp.Config.CONNECT_TIMEOUT * 1000);
                connection.connect();
                ...
                Log.d(mahiti.org.oelp.Config.LOGTAG, "io exception during HEAD " + e.getMessage());
                throw e;
        ...
        private void download() throws Exception {
            ...
            try {
                ...
                if (tryResume) {
                    ...
                    Log.d(mahiti.org.oelp.Config.LOGTAG, "http download trying resume after" + resumeSize + " of " + expected);
                ...
                if (tryResume && serverResumed) {
                    Log.d(mahiti.org.oelp.Config.LOGTAG, "server resumed");
                    ...
                    if (expected != reportedContentLengthOnGet) {
                        Log.d(mahiti.org.oelp.Config.LOGTAG, "content-length reported on GET (" + reportedContentLengthOnGet + ") did not match Content-Length reported on HEAD (" + expected + ")");
                    }
                ...
                Log.d(mahiti.org.oelp.Config.LOGTAG, "http download failed " + e.getMessage());
                throw e;
            } catch (IOException e) {
