package mahiti.org.oelp.chat.service;
...
import mahiti.org.oelp.chat.utilies.AppSettings;
...
import static mahiti.org.oelp.chat.Constants.PORT;
...
//                SmackConfiguration.DEBUG = true;
    ...
    public boolean reconnectAndLogin(String username) {
        ...
        if (!isConnected()) {
            Log.d(TAG, "reConnection not connected, trying to login and connect");
            try {
                // Save username and password then use here
                this.connection = getConnection();
                Log.d(TAG, "XMPP username :" + username);
